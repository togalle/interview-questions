...
- What are the main cloud providers and how do they differ?
  - The three major public cloud providers are Amazon Web Services (AWS), Google Cloud Platform (GCP), and Microsoft Azure. AWS has the broadest service catalogue and largest market share. GCP is particularly strong in data analytics, machine learning, and Kubernetes (it invented it). Azure integrates tightly with Microsoft's enterprise ecosystem (Active Directory, Office 365). All three offer equivalent core primitives (VMs, object storage, managed databases, serverless functions).
